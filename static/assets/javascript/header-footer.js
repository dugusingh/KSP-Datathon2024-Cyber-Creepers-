...
<div class="container-fluid px-3 px-md-4">
  ...
  <div class="d-flex align-item pt-2 pb-2 pr-2s-center">
    <a class="navbar-brand shadow-soft py-2 px-3 rounded border border-light mr-xl-4" href="#">
      ...
      <span class="ml-2" style="font-size: large; color: RGB;"><i class="fas fa-chart-pie"></i>&nbsp &nbsp Crime Data Analytics</span>
    </a>
  </div>
  ...
  <div class="d-none d-lg-block">
    ...
    <a href="hotspot-area.html" class="btn btn-primary text-dark mr-2"><i class="fas fa-map"></i>&nbsp Hotspot Area</a> 
  </div>
</div>
